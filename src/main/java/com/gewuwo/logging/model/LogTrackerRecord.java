...
public class LogTrackerRecord implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(project, that.project) && Objects.equals(className, that.className) && Objects.equals(resourceName,
            ...
            that.traceId) && Objects.equals(logLevel, that.logLevel) && Objects.equals(hostIp, that.hostIp) && Objects.equals(time, that.time);
    }

    @Override
    public int hashCode() {
        return Objects.hash(project, className, resourceName, message, threadName, traceId, logLevel, hostIp, time);
    }
